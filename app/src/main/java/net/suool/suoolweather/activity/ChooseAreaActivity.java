package net.suool.suoolweather.activity;
...
public class ChooseAreaActivity extends Activity {
    ...
    private SuooLWeatherDB suooLWeatherDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suooLWeatherDB = suooLWeatherDB.getInstance(this);
    ...
    private void queryProvinces() {
        provinceList = suooLWeatherDB.loadProvinces();
    ...
    private void queryCities() {
        cityList = suooLWeatherDB.loadCities(selectedProvince.getId());
        if (cityList.size() > 0) {
            dataList.clear();
    ...
    private void queryCounties() {
        countyList = suooLWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    result = Utility.handleProvincesResponse(suooLWeatherDB,
                            response);
                } else if ("city".equals(type)) {
                    result = Utility.handleCitiesResponse(suooLWeatherDB,
                            response, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(suooLWeatherDB,
